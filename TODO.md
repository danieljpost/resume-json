...
1) [ ] convert to https://jsonresume.org/schema
...
1) [ ] create a quick bash/Rust script to concatenate all .json files into $timestamp.resume.json then open that file in code for formatting and testing.
